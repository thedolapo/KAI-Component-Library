...
const meta = {
  title: 'UI5 Components/Filter Bar', component: FilterBar,
  args: {
    search: <Input />,
    header: (
...
export const WithLogic = {
  render: () => {
    ...
    const handleFiltersDialogSelectionChange = (payload) => {
...
export const IdentifyInputEventOrigin = {
  parameters: {
    design: {
      type: 'figma',
