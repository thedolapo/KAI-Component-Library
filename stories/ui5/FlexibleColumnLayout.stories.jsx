...
const meta = {
  title: 'UI5 Components/Flexible Column Layout', component: FlexibleColumnLayout,
  argTypes: {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '[→ UI5 React docs](https://ui5.github.io/webcomponents-react/v2/?path=/story/layouts-floorplans-flexiblecolumnlayout--default)',
      },
    },
  },
};
...
export const WithDifferentColumns = {
  render() {
