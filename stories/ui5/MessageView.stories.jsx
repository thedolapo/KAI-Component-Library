...
**Note:** Although this prop accepts all HTML Elements, it is strongly recommended that you only use \`Message\` in order to preserve the intended design.`,
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '[→ UI5 React docs](https://ui5.github.io/webcomponents-react/v2/?path=/story/ui-elements-messageview--default)',
      },
    },
  },
};
...
export const MessageViewInDialog = {
...
export const WithMessageViewButton = {
