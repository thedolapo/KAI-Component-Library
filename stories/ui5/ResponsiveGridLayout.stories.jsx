...
const meta = {
  title: 'UI5 Components/Responsive Grid Layout', component: ResponsiveGridLayout,
  argTypes: {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '[→ UI5 React docs](https://ui5.github.io/webcomponents-react/v2/?path=/story/layouts-floorplans-responsivegridlayout--default)',
      },
    },
  },
};
