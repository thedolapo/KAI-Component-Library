...
const dataLarge = [
  { name: 'Alice Johnson', age: 28, friend: { name: 'Bob Smith', age: 32 } },
  { name: 'Charlie Brown', age: 34, friend: { name: 'Diana Prince', age: 29 } },
  { name: 'Eve Williams', age: 25, friend: { name: 'Frank Castle', age: 41 } },
  { name: 'Grace Hopper', age: 55, friend: { name: 'Hank Pym', age: 48 } },
  { name: 'Iris West', age: 30, friend: { name: 'James Kirk', age: 38 } },
  { name: 'Kara Danvers', age: 26, friend: { name: 'Lena Luthor', age: 31 } },
  { name: 'Mia Stark', age: 22, friend: { name: 'Nick Fury', age: 65 } },
  { name: 'Oliver Queen', age: 37, friend: { name: 'Pepper Potts', age: 35 } },
  { name: 'Quinn Fabray', age: 24, friend: { name: 'Reed Richards', age: 45 } },
  { name: 'Steve Rogers', age: 105, friend: { name: 'Tony Stark', age: 53 } },
];
...
const meta = {
  ...
  parameters: {
    design: {
      type: 'figma',
      url: 'https://www.figma.com/design/rur6NyDAfn3XII6DF4PD8n/Klario-SAP-Fiori-for-Web-UI-Kit?node-id=191125:39286',
    },
    docs: {
      description: {
        component: '[→ UI5 React docs](https://ui5.github.io/webcomponents-react/v2/?path=/story/data-display-table--default)',
      },
    },
  },
};
...
export const WithSelection = {
  render(args) {
    ...
    const [behavior, setBehavior] = useState('RowSelector');
    return (
      <>
        <SegmentedButton
          onSelectionChange={(e) => {
        ...
        <SegmentedButton
          onSelectionChange={(e) => {
            setBehavior(e.detail.selectedItems[0].textContent);
          }}
        >
...
export const VirtualizedTableRows = {
