...
const meta = {
  title: 'UI5 Components/Variant Management', component: VariantManagement,
  args: {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '[→ UI5 React docs](https://ui5.github.io/webcomponents-react/v2/?path=/story/inputs-variantmanagement--default)',
      },
    },
  },
};
...
export const WithFilterBarImplementation = {
  name: 'in FilterBar',
  render: () => {
    ...
    const handleSaveAs = (e) => {
      const {
        variantItem: _omit, selected, readOnly, labelReadOnly,
        ...variantItemProps
      } = e.detail;
    ...
    const handleSave = (e) => {
      const { variantItem: _omit, selected, ...variantItemProps } = e.detail;
      initialVariantValues.current[variantItemProps.children] = filters;
      setIsDirty(false);
    };
    ...
    const handleSaveManageViews = (e) => {
      ...
      updatedVariants.forEach((variant) => {
        const { variantItem: _omit, selected, ...variantItemProps } = variant;
